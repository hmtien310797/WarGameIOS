module("MobaBattleMoveData", package.seeall)
...
function RequestSaveArchiveData(callback)
	if Global.GetMobaMode() == 1 then
		local req = MobaMsg_pb.MsgMobaGetArmySetoutNumRequest()
		req.index = 1

		Global.Request(Category_pb.Moba, MobaMsg_pb.MobaTypeId.MsgMobaGetArmySetoutNumRequest, req,MobaMsg_pb.MsgMobaGetArmySetoutNumResponse,function(msg)		
	...
	elseif Global.GetMobaMode() == 2 then
		local req = GuildMobaMsg_pb.GuildMobaGetArmySetoutNumRequest()
		req.index = 1

		Global.Request(Category_pb.GuildMoba, GuildMobaMsg_pb.GuildMobaTypeId.GuildMobaGetArmySetoutNumRequest, req,GuildMobaMsg_pb.GuildMobaGetArmySetoutNumResponse,function(msg)		
			BattleMove.RecordTime("RequestSaveArchiveData SetData Req Start =================================")
...
function RequestSetArchiveData(index, infos, generals, callback)
	local req = nil--MobaMsg_pb.MsgMobaSetArmySetoutNumRequest()
	if Global.GetMobaMode() == 1 then
		req = MobaMsg_pb.MsgMobaSetArmySetoutNumRequest()
	elseif Global.GetMobaMode() == 2 then
		req = GuildMobaMsg_pb.GuildMobaSetArmySetoutNumRequest()
	end
	...
	if Global.GetMobaMode() == 1 then
		Global.Request(Category_pb.Moba, MobaMsg_pb.MobaTypeId.MsgMobaSetArmySetoutNumRequest, req,MobaMsg_pb.MsgMobaSetArmySetoutNumResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)          
			else
				if SaveArchiveData == nil then
	...
	elseif Global.GetMobaMode() == 2 then
		Global.Request(Category_pb.GuildMoba, GuildMobaMsg_pb.GuildMobaTypeId.GuildMobaSetArmySetoutNumRequest, req,GuildMobaMsg_pb.GuildMobaSetArmySetoutNumResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)          
			else
				if SaveArchiveData == nil then
...
function RequestArchiveData4PVE(callback)
	if Global.GetMobaMode() == 1 then
		local req = MobaMsg_pb.MsgMobaGetArmySetoutUIRequest()
		req.pathType = Common_pb.TeamMoveType_ChapterPvP
		
		Global.Request(Category_pb.Moba, MobaMsg_pb.MobaTypeId.MsgMobaGetArmySetoutUIRequest, req,MobaMsg_pb.MsgMobaGetArmySetoutUIResponse,function(msg)			
	...
	elseif Global.GetMobaMode() == 2 then
		local req = GuildMobaMsg_pb.GuildMobaGetArmySetoutUIRequest()
		req.pathType = Common_pb.TeamMoveType_ChapterPvP
		
		Global.Request(Category_pb.GuildMoba, GuildMobaMsg_pb.GuildMobaTypeId.GuildMobaGetArmySetoutUIRequest, req,GuildMobaMsg_pb.GuildMobaGetArmySetoutUIResponse,function(msg)			
...
function RequestUserFormation(ftype,callback)
	if Global.GetMobaMode() == 1 then
		local req = MobaMsg_pb.MsgMobaGetArmyFormationRequest()
		req.formType = ftype
		Global.Request(Category_pb.Moba, MobaMsg_pb.MobaTypeId.MsgMobaGetArmyFormationRequest, req,MobaMsg_pb.MsgMobaGetArmyFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
	...
	elseif Global.GetMobaMode() == 2 then
		local req = GuildMobaMsg_pb.GuildMobaGetArmyFormationRequest()
		req.formType = ftype
		Global.Request(Category_pb.GuildMoba, GuildMobaMsg_pb.GuildMobaTypeId.GuildMobaGetArmyFormationRequest, req,GuildMobaMsg_pb.GuildMobaGetArmyFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
...
function RequestBuildingFormation(uid , ftype , callback)
	if Global.GetMobaMode() == 1 then
		local req = MobaMsg_pb.MsgMobaGetBuildingFormationRequest()
		req.formType = ftype
		req.uid = uid
		Global.Request(Category_pb.Moba, MobaMsg_pb.MobaTypeId.MsgMobaGetBuildingFormationRequest, req,MobaMsg_pb.MsgMobaGetBuildingFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
	...
	elseif Global.GetMobaMode() == 2 then 
		local req = GuildMobaMsg_pb.GuildMobaGetBuildingFormationRequest()
		req.formType = ftype
		req.uid = uid
		Global.Request(Category_pb.GuildMoba, GuildMobaMsg_pb.GuildMobaTypeId.GuildMobaGetBuildingFormationRequest, req,GuildMobaMsg_pb.GuildMobaGetBuildingFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
...
function SaveFormation(ftype, form, callback)
	if Global.GetMobaMode() == 1 then
		local req = MobaMsg_pb.MsgMobaSetArmyFormationRequest()
		req.formType = ftype
		local count = 0
		...
		Global.Request(Category_pb.Moba, MobaMsg_pb.MobaTypeId.MsgMobaSetArmyFormationRequest, req,MobaMsg_pb.MsgMobaSetArmyFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
	...
	elseif Global.GetMobaMode() == 2 then
		local req = GuildMobaMsg_pb.GuildMobaSetArmyFormationRequest()
		req.formType = ftype
		local count = 0
		table.foreach(form , function(_,v)	
			count = count + 1
		...
		Global.Request(Category_pb.GuildMoba, GuildMobaMsg_pb.GuildMobaTypeId.GuildMobaSetArmyFormationRequest, req,GuildMobaMsg_pb.GuildMobaSetArmyFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
...
function SaveBuildingFormation(ftype, form, preForm, uid, callback)
	local req = nil
	if Global.GetMobaMode() == 1 then
		req = MobaMsg_pb.MsgMobaSetBuildingFormationRequest()
	elseif Global.GetMobaMode() == 2 then
		req = GuildMobaMsg_pb.GuildMobaSetBuildingFormationRequest()
	end
	
	req.formType = ftype
	req.uid = uid
	local count = 0
	table.foreach(preForm , function(_,v)	
		count = count + 1
		if count <=6 then
		    --print(v)
		    req.armyFormFrom.form:append(v)
		end
	...
	table.foreach(form , function(_,v)	
		...
		if count <=6 then
		    --print(v)
		    req.armyFormTo.form:append(v)
		end
		
	end)
	
	if Global.GetMobaMode() == 1 then
		Global.Request(Category_pb.Moba, MobaMsg_pb.MobaTypeId.MsgMobaSetBuildingFormationRequest, req,MobaMsg_pb.MsgMobaSetBuildingFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
	...
	elseif Global.GetMobaMode() == 2 then
		Global.Request(Category_pb.GuildMoba, GuildMobaMsg_pb.GuildMobaTypeId.GuildMobaSetBuildingFormationRequest, req,GuildMobaMsg_pb.GuildMobaSetBuildingFormationResponse,function(msg)	
			if msg.code ~= ReturnCode_pb.Code_OK then
				Global.ShowError(msg.code)
				if callback ~= nil then
					callback(false)
