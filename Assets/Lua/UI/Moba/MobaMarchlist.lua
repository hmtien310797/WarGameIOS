module("MobaMarchlist", package.seeall)
...
local function CloseSelf()
	...
	MobaRadarData.RemoveListener(RefreshRadar)
	Global.CloseUI(_M)
end
...
local function RefreshList(_data)
    ...
    if _type == 1 or _type == 2 or _type == 3 then
	    ...
	    formationSmall:SetRightFormation(MobaRadarData.GetDefendForm())
...
function Awake()
	...
	MobaRadarData.AddListener(RefreshRadar)
end
...
function RefreshRadar()
	local data = MobaRadarData.GetData()
