module("ArenaRewards", package.seeall)
...
local function LoadUI()
    for i, v in ipairs(_ui.rewardMsg) do
...
function Awake()
    ...
    _ui.hintATKLabel.text = TextMgr:GetText(Text.ui_Arena_18)
...
function Show(rewardMsg, callback, status)
    Global.OpenUI(_M)
    _ui.rewardMsg = rewardMsg
