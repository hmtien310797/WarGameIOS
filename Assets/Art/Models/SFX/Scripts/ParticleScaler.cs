...
// 		{
// 			particleSystem.minSize *= scaleFactor;
// 			particleSystem.maxSize *= scaleFactor;
// 			particleSystem.worldVelocity *= scaleFactor;
// 			particleSystem.localVelocity *= scaleFactor;
// 			particleSystem.rndVelocity *= scaleFactor;
//
// 			//some variables cannot be accessed through regular script, we will acces them through a serialized object
