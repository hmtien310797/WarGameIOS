...
namespace Clishow
{
    public class CsFileHelper 
    {
        ...
        public static string GetFileNameAndSuffix(string path)
        {
            if (IsFolder(path))
                return string.Empty;
        ...
        public static bool WriteTxtFile(string str, string path)
        {
            ...
            {
                Debug.Log( "write failed: " + e.ToString());
                return false;
            }
            return true;
        }
        ...
        public static string ReadTxtFile(string path)
        {
            ...
            {
                Debug.LogError("read failed: " + e.ToString());
                return string.Empty;
            }
        }
        ...
        public static bool WriteJsonFile(object obj, string path, bool pretty_print = false)
        {
            ...
            {
                Debug.Log("write json failed: " + e.ToString());
                return false;
            }
            return true;
        }
        ...
        public static T ReadJsonFile<T>(string path)
        {
            ...
            {
                Debug.LogError("read json failed: " + e.ToString());
                return default(T);
            }
            catch (Exception e)
            {
