...
public class UILabel2GrayControllerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UILabel2GrayController), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_Label(IntPtr L)
	{
		...
		try
		{
			...
			UILabel2GrayController obj = (UILabel2GrayController)o;
