...
public class UITweenerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("ClearOnFinished", ClearOnFinished);
		...
		L.RegFunction("PlayAllTweener", PlayAllTweener);
		L.RegFunction("ResetAllToBegining", ResetAllToBegining);
		L.RegFunction("PlayAllTweenerDestory", PlayAllTweenerDestory);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ClearOnFinished(IntPtr L)
	{
		try
		{
	...
	static int ResetToBeginning(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UITweener)))
			{
				UITweener obj = (UITweener)ToLua.ToObject(L, 1);
				obj.ResetToBeginning();
				return 0;
			}
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UITweener), typeof(bool)))
			{
				UITweener obj = (UITweener)ToLua.ToObject(L, 1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UITweener.ResetToBeginning");
			}
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PlayAllTweener(IntPtr L)
	{
		try
		{
			...
			UITweener.PlayAllTweener(arg0, arg1, arg2, arg3);
			return 0;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ResetAllToBegining(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 1, typeof(UnityEngine.GameObject));
			bool arg1 = LuaDLL.luaL_checkboolean(L, 2);
			UITweener.ResetAllToBegining(arg0, arg1);
			return 0;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PlayAllTweenerDestory(IntPtr L)
	{
		try
		{
			...
			UITweener.PlayAllTweenerDestory(arg0, arg1, arg2, arg3, arg4);
			return 0;
		}
		catch(Exception e)
		{
