...
public class NGUIMathWrap
{
	...
	static int CalculateRelativeWidgetBounds(IntPtr L)
	{
		try
		{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform), typeof(UnityEngine.Transform), typeof(bool), typeof(bool)))
			{
				UnityEngine.Transform arg0 = (UnityEngine.Transform)ToLua.ToObject(L, 1);
				UnityEngine.Transform arg1 = (UnityEngine.Transform)ToLua.ToObject(L, 2);
				bool arg2 = LuaDLL.lua_toboolean(L, 3);
				bool arg3 = LuaDLL.lua_toboolean(L, 4);
				UnityEngine.Bounds o = NGUIMath.CalculateRelativeWidgetBounds(arg0, arg1, arg2, arg3);
				ToLua.Push(L, o);
				return 1;
			}
			else
	...
	static int GetPivotOffset(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UIWidget.Pivot arg0 = (UIWidget.Pivot)ToLua.CheckObject(L, 1, typeof(UIWidget.Pivot));
	...
	static int ResizeWidget(IntPtr L)
	{
		try
		{
			...
			if (count == 6 && TypeChecker.CheckTypes(L, 1, typeof(UIWidget), typeof(UIWidget.Pivot), typeof(float), typeof(float), typeof(int), typeof(int)))
			{
				...
				UIWidget.Pivot arg1 = (UIWidget.Pivot)ToLua.ToObject(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
				float arg3 = (float)LuaDLL.lua_tonumber(L, 4);
