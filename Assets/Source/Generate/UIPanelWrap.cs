...
public class UIPanelWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("AddRQueueRange", get_AddRQueueRange, set_AddRQueueRange);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_AddRQueueRange(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			int ret = obj.AddRQueueRange;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index AddRQueueRange on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_AddRQueueRange(IntPtr L)
	{
		object o = null;
