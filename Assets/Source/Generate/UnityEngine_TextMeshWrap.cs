...
public class UnityEngine_TextMeshWrap
{
	...
	static int get_offsetZ(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index offsetZ on a nil value" : e.Message);
		}
	}
	...
	static int get_characterSize(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index characterSize on a nil value" : e.Message);
		}
	}
