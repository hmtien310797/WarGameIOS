...
public class UIViewportWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("changeOrthoSizeByScreenHeight", get_changeOrthoSizeByScreenHeight, set_changeOrthoSizeByScreenHeight);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_changeOrthoSizeByScreenHeight(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIViewport obj = (UIViewport)o;
			bool ret = obj.changeOrthoSizeByScreenHeight;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index changeOrthoSizeByScreenHeight on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_changeOrthoSizeByScreenHeight(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			obj.changeOrthoSizeByScreenHeight = arg0;
			return 0;
		}
		catch(Exception e)
		{
