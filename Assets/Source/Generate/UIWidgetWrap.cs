...
public class UIWidgetWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("mTimeScale", get_mTimeScale, set_mTimeScale);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_mTimeScale(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			bool ret = obj.mTimeScale;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index mTimeScale on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_mTimeScale(IntPtr L)
	{
		object o = null;
