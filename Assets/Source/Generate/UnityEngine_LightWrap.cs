...
public class UnityEngine_LightWrap
{
	...
	static int get_shadowResolution(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			LightShadowResolution ret = obj.shadowResolution;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_isBaked(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			bool ret = obj.bakingOutput.isBaked;
	...
	static int set_shadowResolution(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			LightShadowResolution arg0 = (LightShadowResolution)ToLua.CheckObject(L, 2, typeof(LightShadowResolution));
