...
public class UIWrapContentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("UpdateSpecialItem", UpdateSpecialItem);
		...
		L.RegVar("numUsableChildren", get_numUsableChildren, set_numUsableChildren);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int UpdateSpecialItem(IntPtr L)
	{
		try
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_numUsableChildren(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIWrapContent obj = (UIWrapContent)o;
			int ret = obj.numUsableChildren;
			LuaDLL.lua_pushinteger(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index numUsableChildren on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_numUsableChildren(IntPtr L)
	{
		object o = null;
