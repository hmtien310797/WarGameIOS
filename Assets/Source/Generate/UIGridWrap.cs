...
public class UIGridWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("reversePosition", get_reversePosition, set_reversePosition);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_reversePosition(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIGrid obj = (UIGrid)o;
			bool ret = obj.reversePosition;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index reversePosition on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_reversePosition(IntPtr L)
	{
		object o = null;
