...
public class PlaneShadowWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(PlaneShadow), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_Offset(IntPtr L)
	{
		...
		try
		{
			...
			PlaneShadow obj = (PlaneShadow)o;
			UnityEngine.Vector4 ret = obj.Offset;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
