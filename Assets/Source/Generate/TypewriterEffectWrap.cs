...
public class TypewriterEffectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("timeLimit", get_timeLimit, set_timeLimit);
	...
	static int get_timeLimit(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			TypewriterEffect obj = (TypewriterEffect)o;
			float ret = obj.timeLimit;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index timeLimit on a nil value" : e.Message);
		}
	}
