...
public class UICameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("UICanGetEvents", get_UICanGetEvents, set_UICanGetEvents);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_UICanGetEvents(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UICamera.UICanGetEvents);
			return 1;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_UICanGetEvents(IntPtr L)
	{
		try
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			UICamera.UICanGetEvents = arg0;
			return 0;
		}
		catch(Exception e)
		{
