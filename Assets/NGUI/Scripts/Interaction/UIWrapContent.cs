...
public class UIWrapContent : MonoBehaviour
{
    ...
    public int numUsableChildren = int.MaxValue;
	...
	public virtual void SortBasedOnScrollMovement ()
	{
		...
		mChildren.Clear();
		for (int i = 0; i < Mathf.Min(numUsableChildren, mTrans.childCount); ++i)
    ...
    public void UpdateSpecialItem(int child)
    {
        Transform t = mChildren[child];
        if( t )
        {
            UpdateItem(t, child);
        }
