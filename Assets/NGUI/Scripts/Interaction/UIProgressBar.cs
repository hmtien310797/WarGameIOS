...
public class UIProgressBar : UIWidgetContainer
{
    ...
    /// <summary>
    /// Cached for gameobject.
    /// </summary>

    public GameObject cachedGameObject { get { if (mGameObject == null) mGameObject = gameObject; return mGameObject; } }

    /// <summary>
    /// Cached for transform.
    /// </summary>
	...
	{
#if PROFILER
        Profiler.BeginSample("UIProgressBar_update");
#endif
#if UNITY_EDITOR
