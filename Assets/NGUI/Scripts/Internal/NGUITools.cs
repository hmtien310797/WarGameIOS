...
//#endif
	...
	static public void SetActive (GameObject go, bool state) { SetActive(go, state, false); }
	...
	static public string clipboard
	{
...
#if UNITY_ANDROID
                AndroidJavaObject androidObject = new AndroidJavaObject("com.weywell.weysdk.ClipboardTools");
		...
		set
		{
            ...
            else
            {
                ...
                // 复制到剪贴板
                androidObject.Call("copyTextToClipboard", activity, value);
#endif
            }
        }
	}
...
#if UNITY_5_4_0
                mGameSize = UnityEditor.Handles.GetMainGameViewSize();
#else
