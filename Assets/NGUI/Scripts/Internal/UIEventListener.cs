...
public class UIEventListener : MonoBehaviour
{
    ...
    void OnEnable()                 { if (onActive != null) onActive(gameObject, true); }
    void OnDisable()                { if (onActive != null) onActive(gameObject, false); }
    void OnApplicationQuit()        { if (onActive != null) onActive = null; }
