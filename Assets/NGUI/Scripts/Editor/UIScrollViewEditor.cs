...
public class UIScrollViewEditor : Editor
{
	public override void OnInspectorGUI ()
	{
        ...
        if (NGUIEditorTools.DrawHeader("Custom By Ljy"))
        {
            NGUIEditorTools.DrawProperty("索引滚动视图", serializedObject, "scrollByIndex");
            NGUIEditorTools.DrawProperty("元素大小", serializedObject, "eachSize");
            NGUIEditorTools.DrawProperty("切换距离", serializedObject, "scrollOffset");
            NGUIEditorTools.DrawProperty("忽略隐藏", serializedObject, "hideInactive");
        }
