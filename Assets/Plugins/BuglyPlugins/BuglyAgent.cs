...
//                }
    ...
    // --- dllimport start ---
	private static void _BuglyInit(string appId, bool debug, int level)
    {

    }
	private static void _BuglySetUserId(string userId)
    {

    }
	private static void _BuglySetTag(int tag)
    {

    }
	private static void _BuglySetKeyValue(string key, string value)
    {

    }
	private static void _BuglyReportException(int type, string name, string reason, string stackTrace, string extras, bool quit)
    {

    }
	private static void _BuglyDefaultConfig(string channel, string version, string user, string deviceId)
    {

    }
	private static void _BuglyLogMessage(int level, string tag, string log)
    {

    }
	private static void _BuglyConfigCrashReporterType(int type)
    {

    }
	private static void _BuglySetExtraConfig(string key, string value)
    {
