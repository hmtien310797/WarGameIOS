...
public class VertexPainter2 : EditorWindow {
	...
	EditorGUILayout.Separator();
		...
		if (materialTextures == null) {
			...
			for (int i = 0; i < 2; ++i) {
				...
				materialTextures.Add(new object() as Texture);
				materialBumpMaps.Add(new object() as Texture); 
	...
	void doRandom(string mode) {
		...
		Undo.RecordObject(this, "Apply Random");
		...
		if(myWindow.paintVertexColors){
			...
			if (e.shift && lockObject){  
				...
				if (e.keyCode == KeyCode.Q){
					...
					Undo.RecordObject(this, "Decrease Brush Size");
				...
				if (e.keyCode == KeyCode.W){	
					...
					Undo.RecordObject(this, "Increased Brush Size");
				...
				if (e.keyCode == KeyCode.A){
					...
					Undo.RecordObject(this, "Decreased Brush Strength");
				...
				if (e.keyCode == KeyCode.S){	
					...
					Undo.RecordObject(this, "Increased Brush Strength");		
